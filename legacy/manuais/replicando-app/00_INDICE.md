...
| `04.2_Organizar_Listas.md` | Vínculo Lista-Área, auto-assign de colaboradores, filtro por área, checkboxes no modal de criação |
...
| Arquivo | Conteúdo |
|---------|----------|
| `13_SUPER_ADMIN_RESTAURANTES.md` | Cadastro e controle de restaurantes, solicitações, impersonação, dashboard global, personalização da navbar por perfil |
