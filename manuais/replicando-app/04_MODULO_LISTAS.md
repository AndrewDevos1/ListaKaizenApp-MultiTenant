...
### Elementos:
- **Tabela de listas**: Nome | Colaboradores | Total itens | Data criação | Ações
- **Botão "Nova Lista"**: Modal de criação
- **Botão "Lixeira"**: Ver listas deletadas
- **Ações por lista**: Editar | Gerenciar Itens | Ver Submissões | Deletar
- **Filtros**: Busca por nome, filtro por restaurante (SUPER_ADMIN)
